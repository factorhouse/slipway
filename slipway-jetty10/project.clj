(defproject io.factorhouse/slipway-jetty10 "1.1.6"
  ...
  :profiles {:dev   {:dependencies   [[com.fasterxml.jackson.core/jackson-core "2.14.2"] ;; required for internal inconsistency within clj-kondo
                                      [clj-kondo "2023.04.14" :exclusions [org.ow2.asm/asm]] ;; asm transitive issue with websocket-jetty-server
  ...
  :dependencies [[org.clojure/clojure "1.11.1"]
                 ...
                 [org.eclipse.jetty.websocket/websocket-jetty-server "10.0.15" :exclusions [org.slf4j/slf4j-api]]
                 [org.eclipse.jetty.websocket/websocket-servlet "10.0.15" :exclusions [org.slf4j/slf4j-api]]
                 [org.eclipse.jetty/jetty-server "10.0.15" :exclusions [org.slf4j/slf4j-api]]
                 [org.eclipse.jetty/jetty-jaas "10.0.15" :exclusions [org.slf4j/slf4j-api]]
