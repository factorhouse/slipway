(defproject io.factorhouse/slipway-jetty10 "1.1.20"
  ...
  :profiles {:dev   {:dependencies   [[com.fasterxml.jackson.core/jackson-core "2.18.3"] ;; required for internal inconsistency within clj-kondo, kept at latest for CVE avoidance
                                      [clj-kondo "2025.02.20"]
                                      [clj-http "3.13.0" :exclusions [commons-codec]] ;; later version brought in by jetty-jaas
  ...
  :dependencies [[org.clojure/clojure "1.12.0"]
                 ...
                 [org.eclipse.jetty.websocket/websocket-jetty-api "10.0.25"]
                 [org.eclipse.jetty.websocket/websocket-jetty-server "10.0.25" :exclusions [org.slf4j/slf4j-api]]
                 [org.eclipse.jetty.websocket/websocket-servlet "10.0.25" :exclusions [org.slf4j/slf4j-api]]
                 [org.eclipse.jetty/jetty-server "10.0.25" :exclusions [org.slf4j/slf4j-api]]
                 [org.apache.mina/mina-core "2.2.4"]        ;; exclude mina-core with CVE and manually bump to latest minor version
                 [org.eclipse.jetty/jetty-jaas "10.0.25" :exclusions [org.slf4j/slf4j-api org.apache.mina/mina-core]]
