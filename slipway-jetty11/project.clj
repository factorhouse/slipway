(defproject io.factorhouse/slipway-jetty11 "1.1.6"
  ...
  :profiles {:dev   {:dependencies   [[clj-kondo "2023.02.17" :exclusions [org.ow2.asm/asm]]
  ...
  :dependencies [[org.clojure/clojure "1.11.1"]
                 ...
                 [org.eclipse.jetty.websocket/websocket-jetty-api "11.0.14"]
                 [org.eclipse.jetty.websocket/websocket-jetty-server "11.0.14" :exclusions [org.slf4j/slf4j-api]]
                 [org.eclipse.jetty.websocket/websocket-servlet "11.0.14" :exclusions [org.slf4j/slf4j-api]]
                 [org.eclipse.jetty/jetty-server "11.0.14" :exclusions [org.slf4j/slf4j-api]]
                 [org.eclipse.jetty/jetty-jaas "11.0.14" :exclusions [org.slf4j/slf4j-api]]
